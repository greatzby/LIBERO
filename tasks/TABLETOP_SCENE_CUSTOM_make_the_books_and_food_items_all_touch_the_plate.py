...
class TabletopSceneCustom(InitialSceneTemplates):
    ...
    def define_regions(self):
        ...
        self.regions.update(
            self.get_region_dict(
                region_centroid_xy=[0.20-0.10-0.15, 0.25-0.05-0.40],
...
def main():
    ...
    language = "Make the books and food items all touch the plate"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["plate_1", "black_book_1", "black_book_2", "yellow_book_1", 
                           "red_coffee_mug_1", "porcelain_mug_1", "cookies_1", "milk_1", "macaroni_and_cheese_1"],
        goal_states=[
            ("InContact", "plate_1", "black_book_1"),
            ("InContact", "plate_1", "black_book_2"),
            ("InContact", "plate_1", "yellow_book_1"),
            ("InContact", "plate_1", "cookies_1"),
            ("InContact", "plate_1", "milk_1"),
            ("InContact", "plate_1", "macaroni_and_cheese_1"),
        ],
    )
