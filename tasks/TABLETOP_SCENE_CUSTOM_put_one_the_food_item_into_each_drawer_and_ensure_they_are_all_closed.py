...
def main():
    ...
    language = "Put one the food item into each drawer and ensure they are all closed."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "cookies_1", "macaroni_and_cheese_1", "wooden_cabinet_1", "milk_1"
        ],
        goal_states=[
            ("Any", (
                ("All", 
                    (("In", "cookies_1", "wooden_cabinet_1_middle_region"),
                    ("In", "milk_1", "wooden_cabinet_1_top_region"),
                    ("In", "macaroni_and_cheese_1", "wooden_cabinet_1_bottom_region"),)
                ),
                ("All",
                    (("In", "cookies_1", "wooden_cabinet_1_middle_region"),
                    ("In", "macaroni_and_cheese_1", "wooden_cabinet_1_top_region"),
                    ("In", "milk_1", "wooden_cabinet_1_bottom_region"),)
                ),
                ("All",
                    (("In", "macaroni_and_cheese_1", "wooden_cabinet_1_middle_region"),
                    ("In", "milk_1", "wooden_cabinet_1_top_region"),
                    ("In", "cookies_1", "wooden_cabinet_1_bottom_region"),)
                ),
                ("All",
                    (("In", "milk_1", "wooden_cabinet_1_middle_region"),
                    ("In", "macaroni_and_cheese_1", "wooden_cabinet_1_top_region"),
                    ("In", "cookies_1", "wooden_cabinet_1_bottom_region"),)
                ),
                ("All",
