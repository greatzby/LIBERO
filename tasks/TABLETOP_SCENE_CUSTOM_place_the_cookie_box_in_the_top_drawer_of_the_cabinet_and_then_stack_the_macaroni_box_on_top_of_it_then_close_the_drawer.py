...
def main():
    ...
    language = "Place the cookie box in the top drawer of the cabinet, and then stack the macaroni box on top of it. Then close the drawer."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "macaroni_and_cheese_1", "wooden_cabinet_1", "cookies_1"
        ],
        goal_states=[
            ("In", "cookies_1", "wooden_cabinet_1_top_region"),
            ("RelaxedOn", "macaroni_and_cheese_1", "cookies_1"), 
