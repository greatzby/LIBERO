...
def main():
    ...
    language = "Put the white mug upright on the centre of the top of the microwave."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "porcelain_mug_1", "microwave_1"
        ],
        goal_states=[
            ("On", "porcelain_mug_1", "microwave_1"),
            ("UpRight", "porcelain_mug_1"),
            ("InAir", "porcelain_mug_1", 1.1055)
        ],
    )
