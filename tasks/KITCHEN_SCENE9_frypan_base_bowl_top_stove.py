...
def main():
    ...
    language = "Create a balanced stack on the stove with the frypan as base and upside-down bowl on top"
    
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["chefmate_8_frypan_1", "white_bowl_1", "flat_stove_1"],
        goal_states=[
