...
def main():
    ...
    language = "Stack the two black books so they are upright and their centres are exactly aligned."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["black_book_2", "black_book_1"],
        goal_states=[
            ("Or", ("FlexibleOn", "black_book_2", "black_book_1", 0.01, 0.01), ("FlexibleOn", "black_book_1", "black_book_2", 0.01, 0.01)),
