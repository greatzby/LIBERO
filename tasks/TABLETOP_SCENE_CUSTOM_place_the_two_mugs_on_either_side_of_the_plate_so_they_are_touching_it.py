...
def main():
    ...
    language = "Place the two mugs on either side of the plate so they are touching it."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "red_coffee_mug_1", "porcelain_mug_1", "plate_1"
        ],
        goal_states=[
            ("InContact", "red_coffee_mug_1", "plate_1"),
            ("InContact", "porcelain_mug_1", "plate_1"),
            ("Not", ("RelaxedOn", "porcelain_mug_1", "plate_1")),
            ("Not", ("RelaxedOn", "red_coffee_mug_1", "plate_1")),
            ("Or", 
                ("RelaxedBetween", "red_coffee_mug_1", "plate_1", "porcelain_mug_1", "x"), 
                ("RelaxedBetween", "red_coffee_mug_1", "plate_1", "porcelain_mug_1", "y")
            ),
        ],   
    )
