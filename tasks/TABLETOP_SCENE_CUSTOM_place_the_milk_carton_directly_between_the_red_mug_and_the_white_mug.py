...
def main():
    ...
    language = "Place the milk carton directly between the red mug and the white mug."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "red_coffee_mug_1", "milk_1", "porcelain_mug_1"
        ],
        goal_states=[
            ("RelaxedBetween", "red_coffee_mug_1", "milk_1", "porcelain_mug_1", "x"),
            ("RelaxedBetween", "red_coffee_mug_1", "milk_1", "porcelain_mug_1", "y"),                   
        ],   
    )
