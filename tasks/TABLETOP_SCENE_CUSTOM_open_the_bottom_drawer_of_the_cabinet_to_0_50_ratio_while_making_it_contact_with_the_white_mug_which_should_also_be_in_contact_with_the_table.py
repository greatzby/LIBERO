...
def main():
    ...
    language = "Open the bottom drawer of the cabinet to 0.50 ratio while making it contact with the white mug which should also be in contact with the table."
    register_task_info(
        language,
    ...
    "porcelain_mug_1",
        ...
        goal_states=[
        ("OpenRatio", "wooden_cabinet_1_bottom_region", 0.5),
        ("InContact", "wooden_cabinet_1", "porcelain_mug_1"),
        ("Not", ("InAir", "porcelain_mug_1", 0.8980)),
        ("Not", ("DistanceBetween", "wooden_cabinet_1", "porcelain_mug_1", 10, 0.1746, 10)), 
    ]
    )
