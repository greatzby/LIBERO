...
def main():
    ...
    language = "Build a tower: White mug at the bottom, macaroni in the middle, milk carton on top."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["macaroni_and_cheese_1", "porcelain_mug_1", "milk_1"],
        goal_states=[
    ("On", "macaroni_and_cheese_1", "porcelain_mug_1"),
    ("On", "milk_1", "macaroni_and_cheese_1"),
]
    )
