...
def main():
    ...
    language = "Stand one of the black books on its spine."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "black_book_1", "black_book_2"
        ],
        goal_states=[
            ("Or",
             ("And",
                ("AxisAlignedWithin", "black_book_1", "x", 87, 92),
                ("AxisAlignedWithin", "black_book_1", "y", 175, 180),
             ),
             ("And",
                ("AxisAlignedWithin", "black_book_2", "x", 87, 92),
                ("AxisAlignedWithin", "black_book_2", "y", 175, 180),
             ),
             ),
        ],   
    )
