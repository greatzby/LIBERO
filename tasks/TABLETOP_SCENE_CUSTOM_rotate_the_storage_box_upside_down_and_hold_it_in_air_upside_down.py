...
def main():
    ...
    language = "Rotate the storage box upside down and hold it in air upside down"
    register_task_info(
        language,
    ...
    "white_storage_box_1"
        ...
        goal_states=[
        ("AxisAlignedWithinWorldAxis", "white_storage_box_1", "z", 175, 180, "z"),
        ("InAir", "white_storage_box_1", 1.0)
    ]
    )
