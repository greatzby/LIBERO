...
def main():
    ...
    language = "Set the frypan on the stove rotated 30 degrees counterclockwise from facing forward"
    ...
    register_task_info(
        ...
        goal_states=[
            ...
            ("OrientedAtDegree", "chefmate_8_frypan_1", 0.0, 0.0, -30.0, 5.0, 5.0, 5.0),
