...
def main():
    ...
    language = "Stack mugs with a yellow book separating them horizontally."
    register_task_info(
        language,
    ...
    "porcelain_mug_1"
        ...
        goal_states=[
        ("Or", 
            ("Between", "red_coffee_mug_1", "yellow_book_1", "porcelain_mug_1", "z"),
            ("Between", "porcelain_mug_1", "yellow_book_1", "red_coffee_mug_1", "z"),
        ),
        ("Not", ("InContact", "gripper0_finger1", "porcelain_mug_1")),
        ("Not", ("InContact", "gripper0_finger2", "porcelain_mug_1")),
        ("Not", ("InContact", "gripper0_hand", "porcelain_mug_1")),
