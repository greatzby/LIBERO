...
def main():
    ...
    language = "Make all three food items line with each other vertically without touching each other."
    register_task_info(
        language,
    ...
    "cookies_1"
        ...
        goal_states=[
        ("DistanceBetween", "macaroni_and_cheese_1", "cookies_1", 0.02, 0.02, 10),
        ("DistanceBetween", "milk_1", "macaroni_and_cheese_1", 0.02, 0.02, 10),
        ("DistanceBetween", "milk_1", "cookies_1", 0.02, 0.02, 10),
        ("Not", ("InContact", "macaroni_and_cheese_1", "cookies_1")),
        ("Not", ("InContact", "milk_1", "cookies_1")),
        ("Not", ("InContact", "macaroni_and_cheese_1", "milk_1")),
    ]
    )
