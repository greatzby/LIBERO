...
def main():
    ...
    language = "Place the Macaroni box inside the top drawer of the cabinet. Then place the yellow book on top of it and close the drawer. Make sure that the yellow book doesn't touch the cabinet."
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        ("In", "yellow_book_1", "wooden_cabinet_1_top_region"),
        ("RelaxedOn", "yellow_book_1", "macaroni_and_cheese_1"),
        ("Close", "wooden_cabinet_1_top_region"),
        ("Not", ("InContact", "yellow_book_1", "wooden_cabinet_1"))
    ]
    )
