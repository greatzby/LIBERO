...
def main():
    ...
    language = "Place the plate on top of a black book that is lying flat."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "black_book_1", "black_book_2", "plate_1"
        ],
        goal_states=[
            ("Or", ("All", (
                    ("FlexibleOn", "plate_1", "black_book_1", 0.05, 0.05),
                    ("AxisAlignedWithin", "black_book_1", "z", 87, 93),
                    ("Or", ("AxisAlignedWithin", "black_book_1", "x", 175, 180), ("AxisAlignedWithin", "black_book_1", "x", 0, 5)),
                    )),
                    ("All", (
                    ("FlexibleOn", "plate_1", "black_book_2", 0.05, 0.05),
