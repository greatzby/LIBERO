...
def main():
    ...
    language = "Turn the storage box so it's opening is upwards. Then balance the milk and macaroni and cheese on it. Ensure that the storage box is still on the table."
    register_task_info(
        language,
    ...
    "macaroni_and_cheese_1"
        ...
        goal_states=[
        ("AxisAlignedWithinWorldAxis", "white_storage_box_1", "z", 85, 95, "z"),
        ("AxisAlignedWithinWorldAxis", "white_storage_box_1", "y", 85, 95, "y"),
        ("RelaxedOn", "milk_1", "white_storage_box_1"),
        ("RelaxedOn", "macaroni_and_cheese_1", "white_storage_box_1"),
        ("Not", ("InAir", "white_storage_box_1", 1.0)),
