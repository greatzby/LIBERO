...
def main():
    ...
    language = "Place the cookie box on the handle of the closed top drawer."
    register_task_info(
        language,
    ...
    "wooden_cabinet_1"
        ...
        ("InAir", "cookies_1", 1.10),
        ("Not", ("DistanceBetween", "wooden_cabinet_1", "cookies_1", 10, 0.0897, 10)), 
        ("Not", ("InContact", "gripper0_finger1", "cookies_1")),
        ("Not", ("InContact", "gripper0_finger2", "cookies_1")),
        ("Not", ("InContact", "gripper0_hand", "cookies_1")),
    ]
    )
