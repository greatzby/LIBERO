...
def main():
    ...
    language = "Stack the three books in an alternating color pattern."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "black_book_1", "black_book_2", "yellow_book_1"
        ],
        goal_states=[
            ("Or", ("All", (
                    ("On", "yellow_book_1", "black_book_1"),
                    ("On", "black_book_2", "yellow_book_1"),
                    )),
                    ("All", (
                    ("On", "yellow_book_1", "black_book_2"),
