...
def main():
    ...
    language = "Put both mugs next to each other on top of the shelf."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["porcelain_mug_1", "red_coffee_mug_1", "wooden_shelf_1"],
        goal_states=[
    ("RelaxedOn", "red_coffee_mug_1", "wooden_shelf_1"),
    ("RelaxedOn", "porcelain_mug_1", "wooden_shelf_1"),
    ("InAir", "porcelain_mug_1", 1.138),
    ("InAir", "red_coffee_mug_1", 1.142),
    ("DistanceBetween", "red_coffee_mug_1", "porcelain_mug_1", 0.10, 0.10, 0.01)
]
    )
