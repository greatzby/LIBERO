...
def main():
    ...
    language = "Lift the storage box until its bottom level is in level with the microwave roof."
    register_task_info(
        language,
    ...
    "microwave_1"
        ...
        goal_states=[
        ("SameHeight", "white_storage_box_1_bottom_side", "microwave_1_top_side"),
        ("UpRight", "white_storage_box_1"),
    ]
    )
