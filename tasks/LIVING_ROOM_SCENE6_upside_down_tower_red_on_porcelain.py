...
def main():
    ...
    language = "create an upside down tower by placing the upside down red mug on the upside down porcelain mug"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["red_coffee_mug_1", "porcelain_mug_1", "plate_1", "chocolate_pudding_1"],
        goal_states=[
