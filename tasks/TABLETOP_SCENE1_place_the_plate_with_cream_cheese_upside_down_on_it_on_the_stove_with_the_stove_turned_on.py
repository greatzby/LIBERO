...
def main():
    ...
    language = "Place the plate with cream cheese upside down on it on the stove with the stove turned on"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["plate_1", 'flat_stove_1', 'cream_cheese_1'],
        goal_states=[
