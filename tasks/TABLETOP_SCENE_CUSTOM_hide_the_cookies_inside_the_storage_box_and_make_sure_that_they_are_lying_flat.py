...
def main():
    ...
    language = "Hide the cookies inside the storage box and make sure that they are lying flat."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["cookies_1", "white_storage_box_1"],
        goal_states=[
    ("DistanceBetween", "cookies_1", "white_storage_box_1", 0.028, 0.045, 0.025),
    ("RelaxedOn", "cookies_1", "white_storage_box_1"),
    ("Upright", "cookies_1"),
]
    )
