...
def main():
    ...
    language = "Make all the food items touch every other food item"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "cookies_1", "milk_1", "macaroni_and_cheese_1"
        ],
        goal_states=[
            ("InContact", "cookies_1", "milk_1"),
            ("InContact", "cookies_1", "macaroni_and_cheese_1"),
            ("InContact", "milk_1", "macaroni_and_cheese_1"),                 
        ],   
    )
