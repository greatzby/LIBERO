...
def main():
    ...
    language = "Build a tower with cream cheese on bottom and alphabet soup on top, positioned next to the basket with at least one component touching the basket"
    register_task_info(
        language,
        ...
        goal_states=[
            ...
            ("Not", ("In", "alphabet_soup_1", "basket_1_contain_region")),
            ("Or",
