...
def main():
    ...
    language = "Use the upright black books as the base and make a bridge using a yellow book"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["black_book_1", "black_book_2", "yellow_book_1"],
        goal_states=[
            ("Upright", "black_book_1"),
            ("Upright", "black_book_2"),
            ("RelaxedOn", "yellow_book_1", "black_book_1"),
            ("RelaxedOn", "yellow_book_1", "black_book_2"),
            
            # add "bridge" angle check to yellow book
            ("AxisAlignedWithin", "yellow_book_1", "z", 87, 93),
