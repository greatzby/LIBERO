...
def main():
    ...
    language = "Lean the yellow book against the shelf without its spine touching the table. Then balance the cookie box on top. Make sure that the cookie box doesn't touch the shelf."
    register_task_info(
        language,
