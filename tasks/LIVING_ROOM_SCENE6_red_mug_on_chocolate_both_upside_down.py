...
def main():
    ...
    language = "place the red coffee mug on the chocolate pudding with both items upside down"
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=["red_coffee_mug_1", "chocolate_pudding_1", "plate_1", "porcelain_mug_1"],
        goal_states=[
