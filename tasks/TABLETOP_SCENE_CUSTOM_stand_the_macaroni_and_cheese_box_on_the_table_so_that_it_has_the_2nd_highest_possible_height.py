...
def main():
    ...
    language = "Stand the macaroni and cheese box on the table so that it has the 2nd highest possible height."
    register_task_info(
        language,
        ...
        goal_states=[
            ("AxisAlignedWithin", "macaroni_and_cheese_1", "y", 87, 92),
            ("Or", ("AxisAlignedWithin", "macaroni_and_cheese_1", "x", 0, 5), ("AxisAlignedWithin", "macaroni_and_cheese_1", "x", 175, 180)),
            ("Not", ("InAir", "macaroni_and_cheese_1", 0.9422)),
            ("InAir", "macaroni_and_cheese_1", 0.9420),
        ],
    )
