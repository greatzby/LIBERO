...
def main():
    ...
    language = "Place the red mug upside down, and then stack the white mug upside down on top of it."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "red_coffee_mug_1", "porcelain_mug_1"
        ],
        goal_states=[
            ("UpsideDown", "red_coffee_mug_1"),
            ("UpsideDown", "porcelain_mug_1"),
            ("On", "porcelain_mug_1", "red_coffee_mug_1"),                  
        ],   
    )
