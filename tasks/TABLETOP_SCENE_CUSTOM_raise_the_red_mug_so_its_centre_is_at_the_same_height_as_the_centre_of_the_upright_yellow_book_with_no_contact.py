...
def main():
    ...
    language = "Raise the red mug so its centre is at the same height as the centre of the upright yellow book, with no contact."
    register_task_info(
        language,
    ...
    "yellow_book_1"
        ...
        ("SameHeight", "red_coffee_mug_1", "yellow_book_1"),
        ("Not", ("InAir", "yellow_book_1", 0.8981)),
        ("Not", ("InContact", "yellow_book_1", "red_coffee_mug_1")),
    ]
    )
