...
def main():
    ...
    language = "Put the red mug right next to the milk carton, but ensure they are not touching."
    register_task_info(
        language,
        scene_name=scene_name,
        objects_of_interest=[
            "red_coffee_mug_1", "milk_1"
        ],
        goal_states=[
            ("Not", ("InContact", "red_coffee_mug_1", "milk_1")),
            ("DistanceBetween", "red_coffee_mug_1", "milk_1", 0.1, 0.1, 0.1),                  
        ],   
    )
